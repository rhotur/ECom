package com.automation.eCom.cucumberRunner;
...
//		Options_Runtime[0] = "src/test/java/org/features/"+istx.getCurrentXmlTest().getParameter("FeatureName");
		Options_Runtime[0] = "src/test/java/com/automation/eCom/features";
		Options_Runtime[1] = "--glue";
		Options_Runtime[2] = "com/automation/eCom/stepDefn";
		Options_Runtime[3] = "--glue";
		Options_Runtime[4] = "src/main/java/com/automation/eCom/cucumberRunner";
